...
if __name__ == "__main__":
    ...
    # train_model = DeepFM(dnn_feature_columns, dnn_feature_columns,  device=device)
    train_model = MMOE(dnn_feature_columns, num_tasks=1, expert_dim=8, dnn_hidden_units=(128, 128),
                       tasks=['binary'], device=device)
