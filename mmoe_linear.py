...
from deepctr_torch.layers import FM, DNN, PredictionLayer
...
class MMOE(BaseModel):
    ...
    def __init__(self, dnn_feature_columns, num_tasks, tasks, num_experts=4, expert_dim=8, dnn_hidden_units=(128, 128),
        ...
        super(MMOE, self).__init__(linear_feature_columns=dnn_feature_columns, dnn_feature_columns=dnn_feature_columns,
    ...
    def forward(self, X):
        ...
        for i, mmoe_out in enumerate(mmoe_outs):
            ...
            logit = logit + linear_logit
            # logit = logit + linear_logit + fm_logit
